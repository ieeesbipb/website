  ...
  return (
    ...
    [-webkit-mask-image:linear-gradient(to_right,transparent,black_50%,black_50%,transparent)]"
      ...
      "
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center">
                  <h2 className="text-white text-5xl font-bold flex items-center gap-2 drop-shadow-lg">
                    <Zap className="w-[3rem] h-[3rem] text-white" />
    ...
    [-webkit-mask-image:linear-gradient(to_right,transparent,black_50%,black_50%,transparent)]"
      ...
      "
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center">
                  <h2 className="text-white text-5xl font-bold flex items-center gap-2 drop-shadow-lg">
                    <Globe className="w-[3rem] h-[3rem] text-white" />
                    Global Network
                  </h2>
                </div>
              </div>
    ...
    [-webkit-mask-image:linear-gradient(to_right,transparent,black_50%,black_50%,transparent)]"
      ...
      "
                ...
                <div className="absolute inset-0 z-10 flex items-center justify-center">
                  <h2 className="text-white text-5xl font-bold flex items-center gap-2 drop-shadow-lg">
                    <Cpu className="w-[3rem] h-[3rem] text-white" />
                    Leadership
                  </h2>
                </div>
              </div>
