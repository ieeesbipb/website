...
const RoadmapHistory = dynamic(
  () => import("@/components/about/RoadmapHistory"),
  { ssr: false },
);
const StatsOverview = dynamic(
  () => import("@/components/about/StatsOverview"),
  { ssr: false },
);
const DivisionsSection = dynamic(
  () => import("@/components/about/DivisionsSection"),
  { ssr: false },
);
...
export const metadata: Metadata = {
  ...
  description:
    "Learn about IEEE Student Branch IPB - our mission, vision, divisions, and commitment to advancing technology for humanity.",
};
...
export default async function AboutPage() {
  ...
  const placeholderDivisions = [
    {
      ...
      name: "Executives",
      description:
        "The core leadership team responsible for strategic direction, operations, and overall management of the student branch.",
      subdivisions: [
        "President",
      ...
      members: [
        ...
        },
        {
          ...
          name: "Michael Chen",
          role: "VP External",
          subdivision: "Vice President of External",
          image: null,
        },
        {
          _id: "m2b",
          name: "Emily Davis",
          role: "VP Internal",
          subdivision: "Vice President of Internal",
          image: null,
        },
        {
          _id: "m3",
    ...
    },
    {
      ...
      name: "Education",
      description:
        "Dedicated to organizing workshops, seminars, and study groups to enhance technical skills and academic knowledge.",
    ...
    },
    {
      ...
      description:
        "Focuses on member recruitment, retention, and professional development activities to build a strong community.",
      ...
      members: [
        ...
        },
        {
          _id: "m9",
          name: "Tom Holland",
          role: "Head of Internal Dev",
          subdivision: "Internal Development",
          image: null,
        },
      ],
    },
    {
      ...
      description:
        "Manages the branch's online presence, content creation, and communication channels.",
    ...
    },
    {
      ...
      name: "Relations",
      description:
        "Builds and maintains partnerships with other student branches, industry partners, and the university administration.",
  ...
  const divisions =
    Array.isArray(fetchedDivisions) && fetchedDivisions.length > 0
      ? fetchedDivisions
  ...
  const vision =
    aboutData?.vision ||
    "To be the leading student organization in fostering technical innovation and professional excellence.";
  const mission = Array.isArray(aboutData?.mission)
    ? aboutData.mission
    : [
  ...
  return (
    <main className="min-h-screen bg-deep-navy">
      ...
      <AboutHero title={heroTitle} description={heroIntro} />
