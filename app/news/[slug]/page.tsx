    ...
    const placeholderPosts = [
      {
        ...
        categories: [
          { title: "Achievement", slug: { current: "achievement" } },
        ],
        coverImage: null,
      ...
      },
      {
        ...
        body: [
          ...
          },
          {
            ...
            style: "h3",
            children: [
              { _type: "span", text: "Smart Cities: Beyond Traffic Lights" },
            ],
          },
          {
            _type: "block",
      ...
      },
      {
        ...
        categories: [
          { title: "Recruitment", slug: { current: "recruitment" } },
        ],
        coverImage: null,
            ...
            {post.categories &&
              post.categories.map((cat: any) => (
                <span
                  ...
                  className="px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-sm font-semibold tracking-wide uppercase"
                >
                  {cat.title}
                </span>
              ))}
            ...
            {post.body && post.body.length > 0 ? (
              <PortableText
                ...
                components={{
                  block: {
                    normal: ({ children }) => (
                      <p className="mb-4 text-slate-600">{children}</p>
                    ),
                    h1: ({ children }) => (
                    ...
                    blockquote: ({ children }) => (
                      <blockquote className="border-l-4 border-blue-500 pl-4 italic text-slate-700 my-4">
                        {children}
                      </blockquote>
                    ),
                  },
                  list: {
                    ...
                    number: ({ children }) => (
                      <ol className="list-decimal pl-5 mb-4 text-slate-600">
                        {children}
                      </ol>
                    ),
                  },
